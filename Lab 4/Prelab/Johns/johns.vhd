...
BEGIN
	...
	--d4 is 0100, d5 is 0011 and so on
		CASE Qreg IS
			WHEN "000" => STUDENT_ID <= "0011"; -- d1 = 3 (0011)
         WHEN "100" => STUDENT_ID <= "0001"; -- d2 = 1 (0001)
         WHEN "110" => STUDENT_ID <= "0001"; -- d3 = 1 (0001)
         WHEN "111" => STUDENT_ID <= "0101"; -- d4 = 5 (0101)
         WHEN "011" => STUDENT_ID <= "1000"; -- d5 = 8 (1000)
         WHEN "001" => STUDENT_ID <= "0001"; -- d6 = 1 (0001)
         WHEN OTHERS => STUDENT_ID <= "1110"; -- Error 'E' (1110)
		END CASE;
	END PROCESS;
Q <= Qreg;
END Behavior;