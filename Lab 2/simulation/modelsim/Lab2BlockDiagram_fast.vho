...
ARCHITECTURE structure OF Lab2BlockDiagram IS
...
-- Equation(s):
-- \inst10~0_combout\ = (!\x3~combout\ & ((\x1~combout\ & ((!\x4~combout\) # (!\x2~combout\))) # (!\x1~combout\ & ((\x4~combout\)))))
